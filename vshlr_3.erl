...
-export([start/0, start_link/0, stop/0, i_am_at/2, find/1, add/1]).
...
start() -> gen_server:start({local, xx2}, vshlr_3, [], []).
start_link() -> gen_server:start_link({local, xx2}, vshlr_3, [], []).
