...
-module(messenger).
-export([start_server/0, stop_server/0, server/2, logon/1, logoff/0, message/2, client/2,  message_to_queue/2]).
...
server(User_List,Queue_List) ->
    receive
        ...
        {From, message_to_queue, ToQueue, Message} ->
 			New_Queue_List = server_in_queue(ToQueue, Message,Queue_List), 
...
server_in_queue(To, Message,[]) ->
	New_Queue_List = queue:new(),
	server_in_queue(To, Message,New_Queue_List);
server_in_queue(To, Message,Queue_List) ->
